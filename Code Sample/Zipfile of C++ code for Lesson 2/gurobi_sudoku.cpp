...
//  Gurobi Sudoku
//
//  Created by Ramavarapu Sreenivas on 8/3/22.
//
// from
// https://www.gurobi.com/documentation/9.5/examples/sudoku_cpp_cpp.html
// I had to change the part of the code that requires the user to input 9 x 9 = 81
// many entries that correspond to the partial Sudoku puzzle... we want to read the
// partial puzzle on command-line...
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        string log_name = string(argv[1]) ;
        string str1 = ".log";
        log_name.append(str1);
        env.set("LogFile", log_name);
        env.start();
